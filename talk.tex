...
\begin{frame}{Pure EFT calculation (\texttt{HSSUSY})}
  \begin{center}
    \begin{tabular}{llllll}
      ...
      \midrule
      $\lambda$  & full & $(y_t^4+y_b^4)g_3^2+(y_t^4+y_b^4+y_\tau^4)^2$ & $y_t^4g_3^4$ & -- & -- \\
      $v$        & full & -- & -- & -- & -- \\
      $y_t$      & full & $y_tg_3^4\textcolor{gray}{\,+\,y_t^3 g_3^2+y_t^5}$ & \textcolor{gray}{$y_tg_3^6$} & $\textcolor{gray}{y_tg_3^8}$ & -- \\
      $y_{b,\tau}$ & full & -- & -- & -- & -- \\
      $g_3$      & full & $g_3^4$ &  $g_3^6$ & -- & -- \\
      $g_{1,2}$   & full & -- & -- & -- & -- \\
      \midrule
      $\beta_{\lambda}$ & full & full & full & $y_t^4g_3^6$ & -- \\
      $\beta_{y_t}$    & full & full & full & $y_tg_3^8$ & -- \\
      $\beta_{g_3}$    & full & full & full & $g_3^{0<n\le 8}$ & $g_3^{10}$ \\
      $\beta_{\cdots}$  & full & full & full & -- & -- \\
      \midrule
      $M_h$           & full & $(y_t^4+y_b^4)g_3^2+(y_t^4 + y_b^4)^2$ & $y_t^4 g_3^4\textcolor{gray}{\,+\,y_t^6g_3^2+y_t^8}$ & \textcolor{gray}{$y_t^4 g_3^6$} & -- \\
      \bottomrule
    \end{tabular}
  \end{center}
