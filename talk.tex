...
\begin{frame}{Uncertainty estimate of the EFT calculation}
  ...
  \begin{align*}
    ...
    \textcolor{darkgreen}{\DMhHSSUSYytSM} &= \left| M_h(y_t^{\SM,3\Loop}(M_Z)) - M_h(y_t^{\SM,4\Loop}(M_Z)) \right| & \text{\mycite{1504.05200}} \\
    ...
    \begin{tikzpicture}
      \begin{groupplot}[
        ...
        \nextgroupplot[
          ...
          yticklabels={,115,120,125,130},
          ylabel={$M_h$ / GeV},
          xticklabels=\empty
        ]
        \addplot[red,thick] table[x index=0, y index=1] {data/HSSUSY_MS-Mh-DMh_TB-20_xt--2.44949.dat};
        \addplot[name path=upper,draw=none] table[x index=0, y expr=\thisrowno{1}+\thisrowno{2}] {data/HSSUSY_MS-Mh-DMh_TB-20_xt--2.44949.dat};
        \addplot[name path=lower,draw=none] table[x index=0, y expr=\thisrowno{1}-\thisrowno{2}] {data/HSSUSY_MS-Mh-DMh_TB-20_xt--2.44949.dat};
        ...
        \addplot[red,thick] table[x index=0,y index=2] {data/HSSUSY_MS-Mh-DMh_TB-20_xt--2.44949.dat};
      \end{groupplot}
    \end{tikzpicture}
  \end{center}
\end{frame}
