  ...
  \begin{center}
    \begin{tikzpicture}
      \begin{groupplot}[
        ...
        \addlegendentry{FO};
        \addplot[darkgreen,thick,densely dashed] table[x index=0, y index=1] {\EFTMSdata};
        \addlegendentry{EFT};
        ...
        \addplot[darkgreen,thick,densely dashed] table[x index=0,y index=2] {\EFTMSdata};
  ...
  \begin{center}
    \begin{tikzpicture}
      \begin{groupplot}[
        ...
        \addlegendentry{FO};
        \addplot[darkgreen,thick,densely dashed] table[x index=0, y index=1] {\EFTXtdata};
        \addlegendentry{EFT};
        ...
        \addplot[darkgreen,thick,densely dashed] table[x index=0,y index=2] {\EFTXtdata};
