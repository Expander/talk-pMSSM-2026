...
\newcommand{\DMhgsMSSM}{\ensuremath{\Delta M_h^{(y_t)}}}
  ...
  \begin{center}
    \begin{tikzpicture}
      \begin{groupplot}[
        ...
        \addplot[red,thick,restrict x to domain=-3.5:1] table[x index=0, y index=1] {\NUHMSSMNoFVHimalayaXtdata};
        \addplot[red,thick,dashed,restrict x to domain=1:3.5] table[x index=0, y index=1] {\NUHMSSMNoFVHimalayaXtdata};
        ...
        \addplot[red,thick,restrict x to domain=-3.5:1] table[x index=0,y index=2] {\NUHMSSMNoFVHimalayaXtdata};
      \end{groupplot}
    \end{tikzpicture}
  \end{center}
\end{frame}
...
\begin{frame}{Uncertainty estimate of the EFT calculation}
  ...
  Combination:
  \begin{equation*}
    \DMhHSSUSY = \DMhQpole + \DMhQmatch + \DMhHSSUSYytSM + \DMhEFT
  \end{equation*}
\end{frame}
