  ...
  \begin{center}
    \begin{tikzpicture}
      \begin{groupplot}[
        ...
        \addplot[black,thick] table[x index=0, y index=1] {\NUHMSSMNoFVHimalayaMSdata};
        ...
        \addplot[black,thick] table[x index=0,y index=2] {\NUHMSSMNoFVHimalayaMSdata};
  ...
  \begin{center}
    \begin{tikzpicture}
      \begin{groupplot}[
        ...
        \addplot[black,thick,restrict x to domain=-3.5:1] table[x index=0, y index=1] {\NUHMSSMNoFVHimalayaXtdata};
        \addplot[black,thick,dashed,restrict x to domain=1:3.5] table[x index=0, y index=1] {\NUHMSSMNoFVHimalayaXtdata};
        ...
        \addplot[black,thick,restrict x to domain=-3.5:1] table[x index=0,y index=2] {\NUHMSSMNoFVHimalayaXtdata};
