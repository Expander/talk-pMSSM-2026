...
\begin{frame}{Hybrid calculation (\texttt{NUHMSSMNoFVHimalayaEFTHiggs})}
  ...
  \emph{Precision:} N$^3$LO+N$^3$LL (same as pure EFT calculation), plus
  \begin{itemize}
  \item series of terms of $\ord(v^n/\MS^n)$ is included at $1\Loop$
    and $2\Loop$ level at the respective orders
  \item SQCD-enhanced terms of $x_t^n$ are resummed
  \end{itemize}
\end{frame}
